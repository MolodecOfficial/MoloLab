...
import { ref } from 'vue';
import Rusoil from 'public/account/choice/Rusoil.png'
import RusML from 'public/account/choice/RusML.png'
import MoloLab from 'public/account/choice/MoloLab.png'
const themes = ref([
  {
    id: 1,
    name: 'LKSRusoil',
